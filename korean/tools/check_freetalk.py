...
check_structure.py and english/tools/check_deck.py both verify *mechanics* —
...
too. The three are one spec in three forms.
    ...
    python3 korean/tools/check_freetalk.py              # blocking + warnings
    python3 korean/tools/check_freetalk.py --warnings   # show soft findings
    python3 korean/tools/check_freetalk.py --write-baseline
...
TRACK = REPO / "korean/tracks/4-freetalking"

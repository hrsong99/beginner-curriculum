...
## Dialogue & characters
- **Chat layout:** partner on the left, the learner on the right (lime bubble), one corner sharpened.
...
## Visual system
- Bold cards, 1.5px ink outline, hard offset shadow; **lime accent** for "you" and highlights.
